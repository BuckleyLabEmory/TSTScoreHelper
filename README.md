...
is called “example_scoring_filepath_spreadsheet.csv” and requires the 
filepaths of the videos. For rescoring, the template spreadsheet is 
called “example_rescoring_filepath_spreadsheet.csv” and requires the 
...
We recommend using the MATLAB script over the standalone software for 
best performance.

DIRECTORY

TSTScoreHelperInstallerWindows.zip is the program installer for Windows.

TSTScoreHelperInstallerMax.zip is the program installer for Mac.
